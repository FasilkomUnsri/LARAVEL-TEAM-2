                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('nim') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nm" type="number" class="form-control" name="nim" value="{{ $data->nim }}" maxlength="8" readonly>
                                @if ($errors->has('nim'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('jurusan') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="jurusan" required="" disabled="">
                                ...
                                <option value="KA" {{$data->jurusan === "KM" ? "selected" : ""}} >Komputerisasi Akuntansi</option>
                            </select>
                            </div>
                        </div>
